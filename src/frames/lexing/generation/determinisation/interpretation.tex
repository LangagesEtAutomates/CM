...
\begin{frame}{Interprétation ubiquitaire du non-déterminisme}
  ...
  \tfExampleBlock[y=1mm]{Exemple : reconnaissance de $\alert{abc}$ par l'automate suivant}{
    ...
    $$
    \{1\}
    \uncover<2-|handout>{\xrightarrow{a} \{ 2, 3, 5, 7, 9, 10\}}
    \uncover<3-|handout>{\xrightarrow{b} \{3, 4, 5, 7, 8, 10\}}
    \uncover<4-|handout>{\xrightarrow{c} \{3, 5, 6, 7, 8, 10\}}
    $$
  }
  ...
  \tf[bottom] {
    \begin{tikzpicture}[smAutomaton]
      ...
      \smState[             \smAlert<2|handout> ] (2)  at (1.5, 2.0) {$2$};    
      \smState[             \smAlert<2-|handout>] (3)  at (5.0, 2.0) {$3$};    
      \smState[             \smAlert<3>         ] (4)  at (6.5, 2.0) {$4$};    
      \smState[             \smAlert<2-|handout>] (5)  at (5.0, 0.0) {$5$};    
      \smState[             \smAlert<4->        ] (6)  at (6.5, 0.0) {$6$};    
      \smState[             \smAlert<2-|handout>] (7)  at (4.0, 1.0) {$7$};    
      \smState[             \smAlert<3->        ] (8)  at (7.5, 1.0) {$8$};    
      \smState[             \smAlert<2|handout> ] (9)  at (3.0, 2.0) {$9$};    
      \smState[\smAccepting \smAlert<2-|handout>] (10) at (3.0, 0.0) {$10$};   
