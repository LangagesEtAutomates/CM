...
\begin{frame}{Langages rationnels et langages reconnaissables}
  ...
  \scalebox{.9}{\begin{tikzpicture}
      ...
      \draw[dashed, -latex, structure] (1.2,5) -- (6.8,5);
      \draw[-latex, structure] (-.1,3.5) -- (-.1,4.5);
      \draw[-latex, structure] (0.1,4.5) -- (0.1,3.5);
      \draw[-latex, structure] (1.2,3) -- (2.8,3);
      \draw[-latex, structure] (5.2,3) -- (6.8,3);
      ...
      \draw[structure] (-.1,4.1) node[left]{\tiny Lemme};
      \draw[structure] (-.1,3.9) node[left]{\tiny d'Arden};

      \draw[structure] (.1,4.1) node[right]{\tiny Algorithme de};
      \draw[structure] (.1,3.9) node[right]{\tiny Thompson};

      \draw[structure] (2,3.15) node{\tiny Sous-ensembles de};
      \draw[structure] (2,2.85) node{\tiny Rabin \& Scott};

      \draw[structure] (6,3.15) node{\tiny Méthode de};
      \draw[structure] (6,2.85) node{\tiny Moore};
