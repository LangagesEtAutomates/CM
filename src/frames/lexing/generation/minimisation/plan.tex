...
\begin{frame}{Génération d'analyseur lexical}
  ...
  \scalebox{.9}{\begin{tikzpicture}
      ...
      \draw[rounded corners, alert,fill=alert!20] (8,3) +(-1.2,-.5) rectangle +(1.2,.5) +(0,0) node{\small \begin{tabular}{c}Automate fini\\ minimal \end{tabular}};
      
      \draw[dashed, -latex] (1.2,5) -- (6.8,5);
      \draw[-latex, structure] (0,4.5) -- (0,3.5);
      \draw[-latex, structure] (1.2,3) -- (2.8,3);
      \draw[-latex,alert] (5.2,3) -- (6.8,3);
      ...
      \draw[alert] (6,3.15) node{\tiny Méthode de};
      \draw[alert] (6,2.85) node{\tiny Moore};
