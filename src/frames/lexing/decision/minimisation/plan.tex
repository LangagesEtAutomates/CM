...
\begin{frame}{Génération d'analyseur lexical}
  ...
  \on[y=-1mm]{\footnotesize
    \begin{tikzpicture}
      ...
      \node[smBox, minimum width=2.4cm, minimum height=1cm, alert, fill=alert!20] (min) at (8,0.0) {Automate fini\\minimal};
      ...
      \path[-latex, alert    ]        (dfa) edge            node[align=center]      {Méthode de\\Moore}                 (min);
