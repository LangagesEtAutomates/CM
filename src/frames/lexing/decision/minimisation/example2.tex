...
\begin{frame}{Exemple complet}
  ...
  \on[x=-.25\textwidth, top]{
    \begin{tikzpicture}[automaton, x=10mm, y=10mm]
      \state[initial,   fill=alert!10                                    ] (0) at (0,1) {0};
      \state[           fill=alert!10, apply on={<4->}{fill=structure!10}] (1) at (1,2) {1};
      \state[accepting, example                                          ] (2) at (1,0) {2};
      \state[           fill=alert!10                                    ] (3) at (2,1) {3};
      \state[accepting, example, structure on=<2->                       ] (4) at (3,1) {4};
      \state[accepting, example, alert on=<3->                           ] (5) at (4,2) {5};
      \state[accepting, example                                          ] (6) at (4,0) {6};
      \state[accepting, example                                          ] (7) at (5,1) {7};
