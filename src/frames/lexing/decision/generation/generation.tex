...
\begin{frame}{Génération d'un automate}
  ...
  \onImage[x=40mm,y=15mm]{%
    ...
    title={Ken Thompson},
    licenselogo={\ccbysa},
    license={{\href{https://creativecommons.org/licenses/by-sa/4.0/}{CC BY-SA-4.0}} -- A.C.Diller, 2019 (\href{https://commons.wikimedia.org/wiki/File:Brian_Kernighan_and_Ken_Thompson.jpg}{Wikimedia})},
    img={Thompson.jpg}
  }
\end{frame}
