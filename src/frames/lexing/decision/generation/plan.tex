...
\begin{frame}{Génération d'analyseur lexical}
  ...
  \on[y=-1mm]{\footnotesize
    \begin{tikzpicture}
      ...
      \node[smBox, minimum width=2.4cm, minimum height=1cm, alert, fill=alert!20] (nfa) at (0,0.0) {Automate fini\\non-déterministe};
      ...
      \path[-latex, alert    ]        (exp) edge[bend left] node[right, align=left] {Algorithme de\\Thompson}           (nfa);
