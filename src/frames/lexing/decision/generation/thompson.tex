...
\begin{frame}{Algorithme de Thompson}
  ...
  \on[y=-3mm]{\footnotesize
    \begin{algorithm}[H]
      ...
      \Fn{\Thompson(\Motif : \textsc{regex}, $\Sigma$ : alphabet) : automate}{
        ...
        \uSi{$\Motif = \emptyset$}{
          ...
          \vspace{.5mm}
        }\uSinonSi{$\Motif = a\in \Sigma \cup \{\varepsilon\}$}{
          \vspace{.5mm}
          \uncover<3->{
            $\begin{array}{@{}l@{\,\gets\,}l@{}}
              Q & \{\alert{q_0}, \alert{q_f}\};\\
