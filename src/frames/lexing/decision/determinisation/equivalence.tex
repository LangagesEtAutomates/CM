...
\begin{frame}{Théorème d'équivalence entre AFN et AFD}
  ...
  \onImage[x=12mm,y=15mm]{%
    ...
    license={{\href{https://creativecommons.org/licenses/by-sa/2.0/}{CC BY-SA}} (\ccbysa{} — Konrad Jacobs, \href{https://commons.wikimedia.org/wiki/File:M_O_Rabin.jpg}{Wikimedia})},
    img={Rabin.jpg}
  }
  ...
  \onImage[x=42mm,y=15mm]{%
    height=32mm,
    title={Dana S. Scott},
    license={{\href{https://creativecommons.org/licenses/by-sa/2.5/}{CC BY-SA}} (\ccbysa{} — Andrej Bauer, 2003, \href{https://commons.wikimedia.org/wiki/File:Scott_Dana_small.jpg}{Wikimedia})},
    img={Scott.jpg}
  }
