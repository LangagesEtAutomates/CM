...
\begin{frame}{Configurations d'un AFN}
  ...
  \onBlock[top]{Définition -- Configuration d'un AFN}{
    ...
    \end{description}
    $\langle u, q \rangle$ est dite \structure{initiale} si \alert{$q = q_0$} et \structure{acceptante} si \alert{$u=\varepsilon \land q \in F$}
  }

  \onExampleBlock{Exemples}{}
