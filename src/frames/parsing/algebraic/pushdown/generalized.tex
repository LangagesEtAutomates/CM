...
\begin{frame}{Automates finis généralisés}
  ...
  \tfBlock[top=-3mm]{Automate fini généralisé}{
    Si un automate fini n'est pas suffisant, ajouter une structure de données
    \begin{itemize}
    \item Pile : \structure{automate à pile}
    \item Tableau de taille $|u|$ : \structure{machine linéairement bornée}
    \item Ruban infini : \structure{machine de Turing}
    \end{itemize}
  }

  \tfExampleBlock[bottom]{Exemple : le langage $\{a^n b^n | n>0\}$}{
    \begin{algorithm}[H]
