...
\begin{frame}{Langages reconnus par un automate à pile}
  ...
  Soit $A=\langle \Sigma, \Gamma, \blank, Q, I, F, \rightarrow \rangle$ un automate à pile.
  ...
  \begin{block}{Définitions -- Langages reconnus}
    ...
    \item[$\mathcal{L}_F(A)$] est le langage des mots reconnus \alert{par état final}
      ...
      \exists i\in I, \exists \structure{f\in F}, \exists \structure{\pi\in\Gamma^\star}, \langle u, i, \blank \rangle \leadsto_A^\star \langle \varepsilon, \structure{f}, \structure{\pi} \rangle\}}$$
    \item[$\mathcal{L}_\varepsilon(A)$] est le langage des mots reconnus \alert{par pile vide}
      ...
      \exists i\in I, \exists \structure{q\in Q}, \langle u, i, \blank \rangle \leadsto_A^\star \langle \varepsilon, \structure{q}, \structure{\varepsilon} \rangle\}}$$
    \item[$\mathcal{L}(A)$] est le langage des mots reconnus \alert{par état final et pile vide}
      $$\alert{\mathcal{L}(A) = \{u \in \Sigma^\star \mid
      \exists i\in I, \exists \structure{f\in F}, \langle u, i, \blank \rangle \leadsto_A^\star \langle \varepsilon, \structure{f}, \structure{\varepsilon} \rangle\}}$$
    \end{description}
  \end{block}
