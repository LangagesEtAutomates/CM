...
\begin{frame}{Exemple : le langage $\{a^n b^n \mid n\in \mathbb{N}\}$}
  ...
  \on[top]{\small
    $\left\langle \{a, b\}, \{A, \blank\}, \blank, \{0, 1, 2\}, \{0\}, \{2\}, \left\{
    \begin{array}{@{~\langle \langle~}c@{,~}c@{,~}c@{\rangle, \langle}c@{,~}c@{~\rangle \rangle~}}
      0 & a           & \varepsilon &  0 & A            \\ 
      0 & b           & A           &  1 & \varepsilon  \\        
      0 & \varepsilon & \blank    &  2 & \varepsilon  \\        
      1 & b           & A           &  1 & \varepsilon  \\        
  ...
  \on[y=-25mm, x=15mm]{
    \begin{tikzpicture}[pushdown]
      \state[structure ob=<-3>,initial,   ] (a) at (0,0) {$0$}; 
      \state[structure ob=<4-5>           ] (b) at (1,0) {$1$}; 
      \state[structure ob=<6>, accepting, ] (c) at (2,0) {$2$}; 
      ...
      \path[structure ob=<5>]   (b) edge             node[above] {\smPAtrans{\varepsilon}{\blank}{\varepsilon}} (c);
    \end{tikzpicture}
  }
