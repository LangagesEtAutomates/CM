# ComputationTheory/CM

This repository contains modular and reusable teaching materials used to build the slides for the Languages, Computability and Complexity courses at Nantes Université.  
