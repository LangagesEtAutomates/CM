# LangagesEtAutomates/CM

This repository contains modular and reusable teaching materials used to build the slides for the Languages and Automata course at Nantes Université.  
